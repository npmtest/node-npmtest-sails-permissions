...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sails-permissions/node_modules/sails-permissions/api/policies/PermissionPolicy.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sails-permissions/node_modules/sails-permissions/api/policies/PermissionPolicy.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sails-permissions/node_modules/sails-permissions/api/policies/</a> &#187; PermissionPolicy.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (req.options.unknownModel) {</span>
<span class="cstat-no" title="statement not covered" >    return next();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  PermissionService</span>
    .findModelPermissions(options)
    .then(<span class="fstat-no" title="function not covered" >function (permissions) {</span>
<span class="cstat-no" title="statement not covered" >      sails.log.silly('PermissionPolicy:', permissions.length, 'permissions grant',</span>
          req.method, 'on', req.model.name, 'for', req.user.username);
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!permissions || permissions.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >        return res.send(403, { error: PermissionService.getErrorMessage(options) });</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      req.permissions = permissions;</span>
&nbsp;
