...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sails-permissions/node_modules/sails-permissions/api/policies/OwnerPolicy.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sails-permissions/node_modules/sails-permissions/api/policies/OwnerPolicy.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sails-permissions/node_modules/sails-permissions/api/policies/</a> &#187; OwnerPolicy.js</div>
</div>
<div class="body">
 ...
 */
module.exports = <span class="fstat-no" title="function not covered" >function OwnerPolicy (req, res, next) {</span>
  //sails.log('OwnerPolicy()');
<span class="cstat-no" title="statement not covered" >  if (!req.user || !req.user.id) {</span>
<span class="cstat-no" title="statement not covered" >    req.logout();</span>
<span class="cstat-no" title="statement not covered" >    return res.send(500, new Error('req.user is not set'));</span>
  }
&nbsp;
  /*
  ...
  */
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (req.options.modelDefinition.autoCreatedBy === false) {</span>
...
<span class="cstat-no" title="statement not covered" >  if ('POST' == req.method) {</span>
    //req.body || (req.body = { });
<span class="cstat-no" title="statement not covered" >    req.body.createdBy = req.user.id;</span>
<span class="cstat-no" title="statement not covered" >    req.body.owner = req.user.id;</span>
  }
&nbsp;
